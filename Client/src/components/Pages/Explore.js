                  ...
                  <div key={society.id}>
                    <a href={"/c/?id=" + society._id} aria-label="community" rel="noopener" className="miniprofile-post-redirect">
                      <div class="miniprofileCommunities">
                        ...
                        {(society.picture == null || society.picture == "") && <Image className="soc-item-image" alt="" src={Default} />}
                        {(society.picture != null && society.picture != "") && <Image className="soc-item-image" alt="" src={society.picture} />}
